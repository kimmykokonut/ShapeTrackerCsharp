...
using System; //where IDisposable lives

namespace ShapeTracker.Tests 
{
  [TestClass]
  public class TriangleTests : IDisposable //extends functionality
  {
  ...
  {
    Triangle isosTri = new Triangle(5, 4, 4);
    string triType = isosTri.CheckType();
    Assert.AreEqual("isosceles triangle", triType);
  }
  [TestMethod]
  public void CheckType_DeterminsWhenEquilateral_String()
  {
